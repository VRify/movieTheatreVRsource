...
import MovieTheater from './Components/Scenes/MovieTheatre.js';

export default class movieTheatre extends React.Component {
  constructor(){
    super();
...
AppRegistry.registerComponent('movieTheatre', () => movieTheatre);
